...
@section('title', 'Client Contracts')
@section('page_title', 'Client Contracts Management')

@section('content')
    <div class="container-fluid px-4">

        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Client Contracts</h1>
            <a href="#" class="btn btn-primary"><i class="fas fa-file-contract"></i> Add New Contract</a>
        </div>
    ...
    <div class="card-body">
        <table class="table table-striped table-hover align-middle">
            ...
            <tbody>
                <tr>
                    <td>001</td>
                    <td>Road Construction Phase 1</td>
                ...
                <tr>
                    <td>002</td>
                    <td>Bridge Reinforcement Project</td>
