...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Aftabs Building Construction Website</title>
    ...
    <body>
            ...
            <div class="row gx-0 align-items-center" style="height: 45px;">
                <div class="col-lg-6 text-center text-lg-start mb-lg-0">
                    <div class="d-flex flex-wrap">
                        <a href="#" class=" text-white  me-4"><i class="fas fa-map-marker-alt text-secondary me-2"></i>Find A Location</a>
                        <a href="#" class="text-white me-4"><i class="fas fa-phone-alt text-secondary me-2"></i>+01234567890</a>
                        <a href="#" class="text-white me-0"><i class="fas fa-envelope text-secondary me-2"></i>Example@gmail.com</a>
                    </div>
                </div>
                <div class="col-lg-6 text-center text-lg-end">
                    <div class="d-flex align-items-center justify-content-end">
                        {{-- btn-square border --}}
                        <a href="#" class="text-white me-3"><i class="fas fa-clock text-secondary me-2"></i>Mon - Sat 8:00 - 17:30, Sunday - CLOSED</a>
                        <a href="#" class="btn btn-primary btn-square border  rounded-circle border-white me-3"><i class="  fab fa-facebook-f"></i></a>
                        <a href="#" class="btn btn-primary btn-square border  rounded-circle border-white me-3"><i class="  fab fa-twitter"></i></a>
                        <a href="#" class="btn btn-primary btn-square border  rounded-circle border-white me-3"><i class="  fab fa-instagram"></i></a>
                        <a href="#" class="btn btn-primary btn-square border  rounded-circle border-white me-3"><i class="  fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="navbar-nav ms-auto pt-2 pt-lg-0">
                        ...
                        <div class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu m-lg-0">
                                ...
                                <a href="testimonial" class="dropdown-item  rounded-pill  active">Testimonial</a>
        ...
        <div class="container-fluid testimonial py-5">
            <div class="container py-5">
                ...
                <div class="owl-carousel rounded-pill testimonial-carousel wow fadeInUp" data-wow-delay="0.4s">
                    <div class="testimonial-item bg-light p-4">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                ...
                                <div class="d-block">
                                    <h4 class="text-dark">Muhammad Hasnain</h4>
                    ...
                    <div class="testimonial-item bg-light p-4">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                ...
                                <div class="d-block">
                                    <h4 class="text-dark">muhammad imran</h4>
                                    <p class="m-0 pb-3"> student developer </p>
                                    <div class="d-flex text-secondary pe-5">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <div class="footer-btn d-flex align-items-center">
                                <a class="btn btn-secondary btn-md-square rounded-circle me-2" href=""><i class="fab fa-facebook-f text-white"></i></a>
                                <a class="btn btn-secondary btn-md-square rounded-circle  me-2" href=""><i class="fab fa-twitter text-white"></i></a>
                                <a class="btn btn-secondary btn-md-square rounded-circle me-2" href=""><i class="fab fa-instagram text-white"></i></a>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-end text-body">
                        <p class="text-white m-3">By GM software solutions</p>
                    </div>
                </div>
            </div>
        </div>
