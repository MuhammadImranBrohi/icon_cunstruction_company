...
<head>
    <meta charset="utf-8">
    <title>aftab Construction COMPANY </title>
...
<body>
        ...
        <div class="row gx-0 align-items-center" style="height: 45px;">
            ...
            <div class="col-lg-6 text-center text-lg-end">
                <div class="d-flex align-items-center justify-content-end">
                    <a href="#" class="text-white me-3"><i class="fas fa-clock text-secondary me-2"></i>Mon - Sat
                        8:00 - 17:30, Sunday - CLOSED</a>
                    <a href="#" class="btn btn-primary btn-square rounded-circle border border-white me-3"><i
                ...
                <div class="navbar-nav ms-auto pt-2 pt-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-lg-0">
                            <a href="feature" class="dropdown-item rounded-pill">Our Features</a>
                            <a href="blog" class="dropdown-item rounded-pill">Our Blog</a>
                            <a href="team" class="dropdown-item rounded-pill">Our Team</a>
                            <a href="testimonial" class="dropdown-item rounded-pill">Testimonial</a>
                            <a href="404" class="dropdown-item rounded-pill">404 Page</a>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.1s">
                    <div class="about-item-content">
                        ...
                        <div class="row gy-0 gx-4 justify-content-between pb-4">
                            <div class="col-lg-6">
                                <p class="text-dark bg-primary text-white rounded-pill p-2  "><i
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="text-dark bg-primary text-white rounded-pill p-2  mb-0"><i
                                        class="fas fa-check text-secondary me-1"></i> Flexible and cost effective</p>
                            </div>
                        </div>
                        <a class="btn btn-secondary rounded-pill align-content-center d-inline-block py-3 px-5 me-2 flex-shrink-0 wow fadeInUp"
    ...
    <!-- Features Start -
        <div class="container-fluid feature bg-light py-5">
            <div class="container py-5  ">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp bg-primary p-1"  style="border-radius: 35px; "data-wow-delay="0.2s">
                    ...
                    <div class="col-lg-4 wow fadeInUp bg-primary p-1 " style="border-radius: 35px; " data-wow-delay="0.4s">
                        <div class="feature-item text-center border p-5">
                            <div class="feature-img bg-secondary d-inline-flex p-4">
                    ...
                    <div class="col-lg-4 wow fadeInUp bg-primary p-1"  style="border-radius: 35px; " data-wow-delay="0.6s">
                        <div class="feature-item text-center border p-5">
                            <div class="feature-img bg-secondary d-inline-flex p-4">
                                <i class="fas fa-tools text-primary fa-5x"></i>
                            </div>
                            <a href="#" class="h4 text-white d-block my-4">Quality Materials</a>
                            <p class="mb-0 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptatem provident incidunt obcaecati.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid counter py-5">
        <div class="container py-5">
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-xl-3 wow fadeUP" data-wow-delay="0.4s">
                    <div class="counter-box">
                        <div class="counter-item">
                            <div class="counter-item-style"></div>
                            <div class="counter-item-inner p-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="/about"><i class="fas fa-angle-right me-2"></i> Services</a>
                        <a href="/about"><i class="fas fa-angle-right me-2"></i> About Us</a>
                        <a href="/project"><i class="fas fa-angle-right me-2"></i> Latest Projects</a>
                        <a href="/testimonial"><i class="fas fa-angle-right me-2"></i> testimonial</a>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> General Construction</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Property Maintenance</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Project Managment</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Virtual Design & Build</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Residential Construction</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Preconstruction</a>
                        <a href="/index"><i class="fas fa-angle-right me-2"></i> Design Build</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-6 text-center text-md-end text-body">
                    Designed By G M software solution
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-secondary btn-lg rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a>
